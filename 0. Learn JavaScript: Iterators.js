...
jika n%2 ==0, tu adalah nilai true nya
  }
	//isEven ialah Function Pertama,yaitu function boolean
 
  let printMsg = (evenFunc, num) => {
	//evenFunc akan dijadikan wadah yang berisi 
function isEven


//masukan ke dalam variable baru dengan bentuk 
dengan num sebagai argument (n) nya
...
—--------------------------------------------
    ...
    console.log(`The number ${4} is an even number: 
${apakah isEven(4%2 == 0)}.`);
  }
